...
public class Company implements Serializable
{
	...
	public Company(int id, String companyname, int turnover, String companyceoname, String boardofdirectors,
			String selectstockexchange, String selectsector, String aboutcompany, String companyCode) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Company [id=" + id + ", companyname=" + companyname + ", turnover=" + turnover + ", companyceoname="
				+ companyceoname + ", boardofdirectors=" + boardofdirectors + ", selectstockexchange="
				+ selectstockexchange + ", selectsector=" + selectsector + ", aboutcompany=" + aboutcompany
